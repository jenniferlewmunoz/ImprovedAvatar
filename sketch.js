...
function preload() {
  ...
  grabbables.push(new StaticSprite("Apple", 100, 600, 'assets/apple.png'));
  grabbables.push(new StaticSprite("Banana", 200, 600, 'assets/banana.png'));
  grabbables.push(new StaticSprite("Steak", 300, 600, 'assets/steak.png'));
  grabbables.push(new StaticSprite("Bacon", 400, 600, 'assets/bacon.png'));
}
...
function checkSelectAvatar() {
  ...
  if (key === '2') {
    playerAvatar.addMovingAnimation('assets/male_running01.png', 'assets/male_running03.png');
    playerAvatar.addStandingAnimation('assets/male_standing01.png', 'assets/male_standing02.png');
  }
}
